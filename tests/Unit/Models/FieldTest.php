...
it('field model has correct structure', static function (): void {
...
it('field model uses correct traits', static function (): void {
    $reflection = new ReflectionClass(Field::class);
...
it('field model has required methods', static function (): void {
    $reflection = new ReflectionClass(Field::class);
...
it('field model has correct relationships', static function (): void {
    $reflection = new ReflectionClass(Field::class);
...
it('field model has correct method signatures', static function (): void {
    $reflection = new ReflectionClass(Field::class);
